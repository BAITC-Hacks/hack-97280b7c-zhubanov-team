...
| Explain and audit the result | Optional NVIDIA NIM explanation grounded in recomputed server facts, with a local fallback | The UI labels AI versus local text, shows provenance and caveats, and never changes the numeric forecast |
