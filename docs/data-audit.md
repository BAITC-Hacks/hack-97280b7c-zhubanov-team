...
Locations from organizer map links: turbine 1 `43.643198, 78.538828`; turbine 2 `43.645150, 78.535604`. The team reports that organizers did not define a timezone for the source CSV, and rated capacities were not supplied. Keep time interpretation as an explicit scenario and do not convert normalized power to MW.
